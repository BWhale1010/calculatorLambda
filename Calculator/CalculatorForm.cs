...
namespace calculator
{
    public partial class CalculatorForm : Form
    {
        ...
        InitialMemory initialMemory = new InitialMemory();
        ...
        InitialNum initialNum = new InitialNum();
        ...
        {
            label_display.Text = initialMemory.memory;
        }
        ...
        {
            initialMemory.memory = label_display.Text;
            button_MR.Enabled = true;
            button_MC.Enabled = true;
        ...
        {
            initialNum.firstOperand = double.Parse(label_display.Text);

            initialNum.resultNumber = mathOperation.Inverse(initialNum.firstOperand);
            printResult(initialNum.resultNumber);
        }
        // x^2 연산
        private void button_square_Click(object sender, EventArgs e)
        {
            ...
            initialNum.resultNumber = mathOperation.Square(initialNum.firstOperand);
            printResult(initialNum.resultNumber);
        }
        // 루트 연산
        private void button_root_Click(object sender, EventArgs e)
        {
            ...
            initialNum.resultNumber = mathOperation.SquareRoot(initialNum.firstOperand);
            printResult(initialNum.resultNumber);
        }
        // % 연산
        private void button_percent_Click(object sender, EventArgs e)
        {
            ...
            initialNum.resultNumber = mathOperation.Percent(percentOperand);
            printResult(initialNum.resultNumber);
        }
        // +/- 연산
        private void button_convOper_Click(object sender, EventArgs e)
        {
            ...
            initialNum.resultNumber = mathOperation.ReverseSign(initialNum.firstOperand);
            printResult(initialNum.resultNumber);
        }
        ...
        {
            initialNum.firstOperand = 0;
            initialNum.secondOperand = 0;
        ...
        void operatorCheckAndCast(string inputStrNum)
        {
            ...
            initialNum.intNumber = double.Parse(strNumber);
            label_display.Text = initialNum.intNumber.ToString();
        }

        //결과 창
        void printResult(double resultNum)
        {
            initialNum.firstOperand = resultNum;
